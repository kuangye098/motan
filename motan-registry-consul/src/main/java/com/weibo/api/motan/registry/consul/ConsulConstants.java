...
public class ConsulConstants {
	 ...
	 * HEARTBEAT_TTL的字符串格式
	 */
	public static final String TTL_STR = TTL + "s";

	/**
	 * 心跳周期，取ttl的2/3
	 */
	public static final int HEARTBEAT_CIRCLE = (TTL * 1000 * 2) / 3;
	
	/**
	 * 连续检测开关变更的最大次数，超过这个次数就发送一次心跳
	 */
	public static final int MAX_SWITCHER_CHECK_TIMES = 10;
	
	/**
	 * 检测开关变更的频率，连续检测MAX_SWITCHER_CHECK_TIMES次必须发送一次心跳。
	 */
	public static final int SWITCHER_CHECK_CIRCLE = HEARTBEAT_CIRCLE / MAX_SWITCHER_CHECK_TIMES;

	/**
	 * consul服务查询默认间隔时间。单位毫秒
	 */
	public static final int DEFAULT_LOOKUP_INTERVAL = 30000;
